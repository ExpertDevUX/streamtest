            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <div className="flex items-center gap-2 p-2 bg-slate-700/30 rounded-lg">
                    <span className="text-slate-300 flex-1 font-mono">rtmp://103.82.23.38/live</span>
                    <button
                      onClick={() => navigator.clipboard.writeText('rtmp://103.82.23.38/live')}
                      className="text-slate-400 hover:text-white transition-colors"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                ...
                <div>
                  ...
                  <div className="p-2 bg-slate-700/30 rounded-lg">
                    <span className="text-slate-300 font-mono">your-stream-key</span>
                  </div>
                </div>
